...
One more fact completes the claim: the machine is electorally self-locking. The voters 55 and over whom it serves are a majority of the votes actually cast at the elections that make pension law, and their share grows every year [F070?][F038][C25]. That is why the thesis does not bet on persuasion in calm weather; it bets on the countdown, on winners-first design, and on constitutional rewiring (I.13).
...
| C25 | The democratic impasse: the transfer's beneficiaries are the majority of votes cast and the majority grows yearly; normal politics cannot correct the machine — exits are crisis windows, winners-first design, constitutional rewiring | supported | The 55+ voter-majority computation must be pinned [Q32]; two counterarguments (not-a-monolith; counter-majoritarian rules) answered in claim file, not yet in prose |

...
| C25 | The democratic impasse: the transfer's beneficiaries cast half or more of the votes and their share grows yearly; normal politics cannot correct the machine — exits are crisis windows, winners-first design, constitutional rewiring | supported | Computation pinned (Q32 resolved: 53-56% at 2022 legislatives, ~50% in 2024); two counterarguments (not-a-monolith; counter-majoritarian rules) answered in claim file, not yet in prose |
